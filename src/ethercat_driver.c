...
bool ethercat_init() 
{
    ...
    if (ec_init(g_motor_control.ifname))
    {
        ...
        if (ec_config_init(FALSE) > 0)
        {
            ...
            if (ret <= 0) printf("Failed to map Statusword: %d\n", ret);

            // 0x6061:0 Modes of operation display (8 bits)
            txpdo_mapping = 0x60610008;
            ret = ec_SDOwrite(slave, 0x1A00, ++txpdo_count, FALSE, sizeof(txpdo_mapping), &txpdo_mapping, EC_TIMEOUTRXM);
            if (ret <= 0) printf("Failed to map Modes of operation display: %d\n", ret);

            // 0x6064:0 Position actual value (32 bits)
            txpdo_mapping = 0x60640020;
            ret = ec_SDOwrite(slave, 0x1A00, ++txpdo_count, FALSE, sizeof(txpdo_mapping), &txpdo_mapping, EC_TIMEOUTRXM);
            if (ret <= 0) printf("Failed to map Position actual value: %d\n", ret);
            ...
            ret = ec_SDOwrite(slave, 0x1A00, ++txpdo_count, FALSE, sizeof(txpdo_mapping), &txpdo_mapping, EC_TIMEOUTRXM);
            if (ret <= 0) printf("Failed to map Velocity actual value: %d\n", ret);

            // 0x6077:0 Torque actual value (16 bits)
            txpdo_mapping = 0x60770010;
            ret = ec_SDOwrite(slave, 0x1A00, ++txpdo_count, FALSE, sizeof(txpdo_mapping), &txpdo_mapping, EC_TIMEOUTRXM);
            if (ret <= 0) printf("Failed to map Torque actual value: %d\n", ret);
            ...
            if (ret <= 0) printf("Failed to set TxPDO count: %d\n", ret);
            ...
            if (ret <= 0) printf("Failed to set RxPDO assignment count: %d\n", ret);
            ...
            if (ret <= 0) printf("Failed to set TxPDO assignment count: %d\n", ret);
            ...
            if (ret <= 0) printf("Failed to set profile velocity: %d\n", ret);
            ...
            if (ret <= 0) printf("Failed to set max motor speed: %d\n", ret);
            ...
            if (ret <= 0) printf("Failed to set profile acceleration: %d\n", ret);
            ...
            if (ret <= 0) printf("Failed to set profile deceleration: %d\n", ret);
            ...
            if (ret <= 0) printf("Failed to set quick stop deceleration: %d\n", ret);
            ...
            if (ret <= 0) printf("Failed to set motion profile type: %d\n", ret);
