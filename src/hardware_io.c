 ...
 */
 ...
 #define DEFAULT_PROFILE_ACCEL 3000     
 #define DEFAULT_PROFILE_DECEL 3000     
 #define DEFAULT_QUICK_STOP_DECEL 3000  
 ...
 cia402_state_t get_cia402_state(uint16_t statusword)
 {
     ...
     switch (state_bits) {
         case 0x00: return CIA402_STATE_NOT_READY;
         case 0x40: return CIA402_STATE_SWITCH_ON_DISABLED;
         case 0x21: return CIA402_STATE_READY_TO_SWITCH_ON;
         case 0x23: return CIA402_STATE_SWITCHED_ON;
         case 0x27: return CIA402_STATE_OPERATION_ENABLED;
         case 0x07: return CIA402_STATE_QUICK_STOP_ACTIVE;
         case 0x0F: return CIA402_STATE_FAULT_REACTION_ACTIVE;
         case 0x08: return CIA402_STATE_FAULT;
 ...
 {
     switch (state) {
         case CIA402_STATE_NOT_READY:          return "Not Ready To Switch On";
 ...
 static bool configure_rxpdo_mappings(int slave)
 {
     ...
     ret = ec_SDOwrite(slave, 0x1600, ++rxpdo_count, FALSE, sizeof(rxpdo_mapping), 
 ...
 static bool configure_txpdo_mappings(int slave)
 {
     ...
     ret = ec_SDOwrite(slave, 0x1A00, ++txpdo_count, FALSE, sizeof(txpdo_mapping), 
                      &txpdo_mapping, EC_TIMEOUTRXM);
     if (ret <= 0) {
 ...
 static bool configure_motion_parameters(int slave)
 {
     ...
     ret = ec_SDOwrite(slave, 0x6081, 0, FALSE, sizeof(profile_velocity), 
     ...
     ret = ec_SDOwrite(slave, 0x6080, 0, FALSE, sizeof(max_motor_speed), 
                      &max_motor_speed, EC_TIMEOUTRXM);
     if (ret <= 0) {
     ...
     ret = ec_SDOwrite(slave, 0x6083, 0, FALSE, sizeof(profile_acceleration), 
     ...
     ret = ec_SDOwrite(slave, 0x6084, 0, FALSE, sizeof(profile_deceleration), 
     ...
     ret = ec_SDOwrite(slave, 0x6085, 0, FALSE, sizeof(quick_stop_decel), 
     ...
     ret = ec_SDOwrite(slave, 0x6086, 0, FALSE, sizeof(motion_profile_type), 
                      &motion_profile_type, EC_TIMEOUTRXM);
     if (ret <= 0) {
 ...
 bool ethercat_init(void)
 {
     ...
     printf("Setting state to SAFE_OP...\n");
